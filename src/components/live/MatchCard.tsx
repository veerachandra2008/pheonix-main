    ...
    <div className="relative group bg-zinc-900 border border-zinc-800 rounded-3xl p-6 overflow-hidden">
      ...
      {streamLink ? (
        <a
          ...
          className="block text-center w-full mt-6 py-3 bg-white text-black rounded-xl font-black uppercase text-sm hover:bg-blue-500 hover:text-white transition-all"
        >
          Watch Stream
        </a>
      ) : (
        <button className="w-full mt-6 py-3 bg-white text-black rounded-xl font-black uppercase text-sm hover:bg-blue-500 hover:text-white transition-all">
